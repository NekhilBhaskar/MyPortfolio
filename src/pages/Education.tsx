...
const Education = () => {
  const achievements = [
    {
      descr: "Gold Medalist in Weight Lifting in Inter Nit Tournament",
      year: "2024",
    },
    {
      descr: "Bronze Medalist in Tug-of-war in Inter Nit Tournament",
      year: "2024",
    },
    {
      descr: "Qualified in National Talent Search Examination",
      // year: "2020",
    },
    {
