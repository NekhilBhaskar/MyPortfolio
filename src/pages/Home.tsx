  ...
  const skillCategories = [
    {
      ...
      skills: ['Java', 'Python', 'Tailwind', 'SQL', 'NoSQL', 'React', 'JavaScript', 'Node.js', 'Express', 'API Testing', 'Next.js']
    },
    {
          ...
          <div className="max-w-3xl">
            <div className="animate-fade-in">
              ...
              <div className="flex space-x-6">
                <a
                  href="https://github.com/NekhilBhaskar"
                  target="_blank"
                ...
                <a
                  href="https://www.linkedin.com/in/nekhil-bhaskar-53255131a/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-white hover:text-blue-400 transition transform hover:-translate-y-1"
                >
                ...
                <a
                  href="https://leetcode.com/u/NekhilBhaskar/"
                  target='_blank'
                  className="text-white hover:text-blue-400 transition transform hover:-translate-y-1"
                >
